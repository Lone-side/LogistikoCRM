...
- [x] Αναζήτηση στο περιεχόμενο εγγράφων (extracted_text) — κανονικοποιημένη
      για ελληνικά (τόνοι, κεφαλαία, οπτικοί σωσίες PDF/OCR όπως «∆» U+2206
      ή λατινικό «A»· βλ. `accounting/services/text_normalization.py`)
