    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-md w-full">
        ...
        <div className="p-4 space-y-4">
          ...
          >
            ...
            {file ? (
              ...
              <>
                ...
                <p className="text-slate-600 mb-1">Σύρετε αρχείο εδώ ή</p>
                <button
          ...
          {/* Backend error */}
          {errorMessage && (
            <div className="p-2.5 bg-danger-50 border border-danger-100 rounded-lg text-sm text-danger-700">
              {errorMessage}
            </div>
          )}
          ...
          {file && (suggesting || suggestion) && (
            <div className="p-2.5 bg-brand-50 border border-brand-200 rounded-lg text-sm space-y-1">
              {suggesting ? (
