...
class ClientProfile(models.Model):
    ...
    doy = models.CharField('Δ.Ο.Υ.', max_length=100,  blank=True, default='')
    eponimia = models.CharField('Επωνυμία/Επώνυμο', max_length=200)
    onoma = models.CharField('Όνομα', max_length=100,  blank=True, default='')
    onoma_patros = models.CharField('Όνομα Πατρός', max_length=100,  blank=True, default='')
    
    arithmos_taftotitas = models.CharField('Αριθμός Ταυτότητας', max_length=50,  blank=True, default='')
    eidos_taftotitas = models.CharField('Είδος Ταυτότητας', max_length=50,  blank=True, default='')
    prosopikos_arithmos = models.CharField('Προσωπικός Αριθμός', max_length=50,  blank=True, default='')
    amka = models.CharField('Α.Μ.Κ.Α.', max_length=20,  blank=True, default='')
    am_ika = models.CharField('Α.Μ. Ι.Κ.Α.', max_length=50,  blank=True, default='')
    arithmos_gemi = models.CharField('Αριθμός Γ.Ε.ΜΗ.', max_length=50,  blank=True, default='')
    arithmos_dypa = models.CharField('Αριθμός Δ.ΥΠ.Α', max_length=50,  blank=True, default='')
    ...
    filo = models.CharField('Φύλο', max_length=10, choices=[('M', 'Άνδρας'), ('F', 'Γυναίκα')],  blank=True, default='')
    
    diefthinsi_katoikias = models.CharField('Διεύθυνση Κατοικίας', max_length=200,  blank=True, default='')
    arithmos_katoikias = models.CharField('Αριθμός', max_length=20,  blank=True, default='')
    poli_katoikias = models.CharField('Πόλη Κατοικίας', max_length=100,  blank=True, default='')
    dimos_katoikias = models.CharField('Δήμος Κατοικίας', max_length=100,  blank=True, default='')
    nomos_katoikias = models.CharField('Νομός Κατοικίας', max_length=100,  blank=True, default='')
    tk_katoikias = models.CharField('T.K. Κατοικίας', max_length=10,  blank=True, default='')
    tilefono_oikias_1 = models.CharField('Τηλέφωνο Οικίας 1', max_length=20,  blank=True, default='')
    tilefono_oikias_2 = models.CharField('Τηλέφωνο Οικίας 2', max_length=20,  blank=True, default='')
    kinito_tilefono = models.CharField('Κινητό τηλέφωνο', max_length=20,  blank=True, default='')
    
    diefthinsi_epixeirisis = models.CharField('Διεύθυνση Επιχείρησης', max_length=200,  blank=True, default='')
    arithmos_epixeirisis = models.CharField('Αριθμός Επιχείρησης', max_length=20,  blank=True, default='')
    poli_epixeirisis = models.CharField('Πόλη Επιχείρησης', max_length=100,  blank=True, default='')
    dimos_epixeirisis = models.CharField('Δήμος Επιχείρησης', max_length=100,  blank=True, default='')
    nomos_epixeirisis = models.CharField('Νομός Επιχείρησης', max_length=100,  blank=True, default='')
    tk_epixeirisis = models.CharField('Τ.Κ. Επιχείρησης', max_length=10,  blank=True, default='')
    tilefono_epixeirisis_1 = models.CharField('Τηλέφωνο Επιχείρησης 1', max_length=20,  blank=True, default='')
    tilefono_epixeirisis_2 = models.CharField('Τηλέφωνο Επιχείρησης 2', max_length=20,  blank=True, default='')
    email = models.EmailField('Email', blank=True, default='')
    
    trapeza = models.CharField('Τράπεζα', max_length=100,  blank=True, default='')
    ...
    katigoria_vivlion = models.CharField('Κατηγορία Βιβλίων', max_length=10, choices=BOOK_CATEGORY_CHOICES,  blank=True, default='')
    nomiki_morfi = models.CharField('Νομική Μορφή', max_length=100,  blank=True, default='')
    ...
    onoma_xristi_taxisnet = models.CharField('Όνομα Χρήστη Taxis Net', max_length=100,  blank=True, default='')
    kodikos_taxisnet = models.CharField('Κωδικός Taxis Net', max_length=100,  blank=True, default='')
    onoma_xristi_ika_ergodoti = models.CharField('Όνομα Χρήστη Ι.Κ.Α. Εργοδότη', max_length=100,  blank=True, default='')
    kodikos_ika_ergodoti = models.CharField('Κωδικός Ι.Κ.Α. Εργοδότη', max_length=100,  blank=True, default='')
    onoma_xristi_gemi = models.CharField('Όνομα Χρήστη Γ.Ε.ΜΗ.', max_length=100,  blank=True, default='')
    kodikos_gemi = models.CharField('Κωδικός Γ.Ε.ΜΗ.', max_length=100,  blank=True, default='')
    
    afm_sizigou = models.CharField('Α.Φ.Μ Συζύγου', max_length=20,  blank=True, default='')
    afm_foreas = models.CharField('Α.Φ.Μ. Φορέας', max_length=20,  blank=True, default='')
    am_klidi = models.CharField('ΑΜ ΚΛΕΙΔΙ', max_length=50,  blank=True, default='')
